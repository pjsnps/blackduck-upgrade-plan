  ...
  - [**Perform Upgrade, Day of Upgrade (Staging then Production)**](#perform-upgrade-day-of-upgrade-staging-then-production)
    ...
    - [Start the actual upgrade](#start-the-actual-upgrade)
      ...
      - [Monitor the Black Duck database during Database Migration](#monitor-the-black-duck-database-during-database-migration)
        - [Tail the container logs](#tail-the-container-logs)
        - [Check PostgreSQL activity](#check-postgresql-activity)
      ...
      - [docker service scale hub_jobrunner=3](#docker-service-scale-hub_jobrunner3)
      - [docker service scale hub_scan=3](#docker-service-scale-hub_scan3)
      - [](#)
